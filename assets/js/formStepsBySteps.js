...
const $prevBtnThirdForm4 = document.querySelector('.prev-page-2-form4')
const $submitBtnForm4 = document.querySelector('.submitBtn-form4')
const $progressTextForm4 = document.querySelectorAll('.steps-form4 p')
const $progressCheckForm4 = document.querySelectorAll('.steps-form4 .bullet-check-form4')
const $bulletsForm4 = document.querySelectorAll('.steps-form4 .bullet-form4')
let maxForm4 = 2
let currentForm4 = 1
...
function linkEtapa3form4(){
    $slidePageForm4.style.marginLeft = "-50%"
    $bulletsForm4[current - 1].classList.add('actived')
    $progressTextForm4[current - 1].classList.add('actived')
    $progressCheckForm4[current - 1].classList.add('actived')
}

function linkEtapa4form4(){
    $slidePageForm4.style.marginLeft = "-75%"
}